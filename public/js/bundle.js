...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYXNoMjciLCJhIjoiY2tvd2tvd2E0MDc0MzJucnc2b3Q1amR3YiJ9.ED1ckhw2IBBuVZTseMmysw';
...
var showAlert = function showAlert(type, msg) {
  ...
  document.querySelector('body').insertAdjacentElement('afterbegin', htmlObject);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Link send! Check your Mail');
              window.setTimeout(function () {
                return 1500;
              });
            }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'SignUp successfully! Redirecting...');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
},{"./alerts":"alerts.js","axios":"../../node_modules/axios/index.js"}],"stripe.js":[function(require,module,exports) {
"use strict";
...
var stripe = Stripe('pk_test_51ItXgaSG21L3739m1Qx4YbuX46F0aJPg3ZihfBjUJUPRDLLAWwU2axHqYHgO4R8SWFvALSQ8z7Bj6Ynejhvp1vTh00W9oc6VIK');
